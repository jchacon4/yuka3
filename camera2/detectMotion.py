...
from clear2 import killMe
import json
from random import randint

import os

os.rename('output.mp4', 'output_%d.mp4' % randint(0, 5000))
...
out = cv2.VideoWriter('output.mp4', -1, 20.0, (800,450))
...
while True:
    ...
    thresh = cv2.threshold(frameDelta, 49, 255, cv2.THRESH_BINARY)[1]
